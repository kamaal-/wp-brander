...
class Generate_Option {
	...
	public function __construct($sfx){

			$this->plugin_screen_hook_suffix = $sfx;

			// Load admin style sheet and JavaScript.
		    add_action( 'admin_enqueue_scripts', array( $this, 'enqueue_options_styles' ) );
		    add_action( 'admin_enqueue_scripts', array( $this, 'enqueue_options_scripts' ) );
    ...
    public function enqueue_options_scripts() {
            ...
            if ( $this->plugin_screen_hook_suffix == $screen->id ) {
                ...
                wp_enqueue_script( 'gen-options-admin-script', plugins_url( '../assets/js/gen-options-admin.js', __FILE__ ), array( 'jquery' ), $this->version );
     ...
     *
     * @param array   $sections options sections array
     */
     ...
     * Set options fields
     *
     * @param array   $fields options fields array
     */
